...
ticket_7 = Ticket.create(price: 6000, event_id: 3)
ticket_8 = Ticket.create(price: 6000, event_id: 3)
ticket_9 = Ticket.create(price: 4000, event_id: 3)
ticket_10 = Ticket.create(price: 4000, event_id: 4)
ticket_11 = Ticket.create(price: 4000, event_id: 4)
ticket_12 = Ticket.create(price: 4000, event_id: 4)
